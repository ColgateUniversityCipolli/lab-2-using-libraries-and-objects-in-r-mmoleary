...
#| size: "scriptsize"
#| code-fold: FALSE
Treatment = rep((treatment = c("treatment.a", "treatment.b", "control")), times=10)
factor(Treatment) # I made the vector into a factor vector because the information is categorical, and this is preferable if I were to do future manipulations.
```
